...
export default function Home() {
  ...
  return (
    <div className="max-w-[1080px] mx-auto border-x border-[#1f1f1d] bg-[#0c0c0c] min-h-[calc(100vh-56px)] shadow-[0_0_80px_rgba(0,0,0,0.9)]">
      ...
      <section className="px-6 sm:px-12 pt-16 sm:pt-20 pb-14 sm:pb-16 grid grid-cols-1 lg:grid-cols-[1.15fr_0.85fr] gap-10 items-center">
        ...
        <div className="max-w-[540px] space-y-6">
          <div className="inline-flex items-center gap-2.5 text-[11px] tracking-[0.14em] uppercase text-[#9e998e] font-medium">
            <div className="w-5 h-[1px] bg-[#3d3d38]" />
            <span>Contract Intelligence</span>
            <span className="text-[#595750]">·</span>
            <span className="text-[#d4d0c7] normal-case tracking-normal font-normal">
          ...
          <h1 className="font-serif text-[40px] sm:text-[56px] leading-[1.06] font-normal tracking-[-0.02em] text-[#f0ede8]">
            Two contracts.
            <br />
            <em className="italic text-[#c5a059]">One clear path</em>
            <br />
            forward.
          </h1>

          <p className="text-[15px] sm:text-[15.5px] text-[#d4d0c7] leading-[1.75] font-normal">
          ...
          <div className="flex flex-wrap items-center gap-6 pt-2">
            ...
            <div className="text-[12.5px] text-[#9e998e] tracking-[0.02em] font-normal">
      ...
      <div className="w-full h-[1px] bg-[#1f1f1d]" />

      {/* 2. Feature Strip / How it works */}
      <section className="grid grid-cols-1 sm:grid-cols-3 border-b border-[#1f1f1d]">
        <div className="p-8 sm:p-10 sm:border-r border-[#1f1f1d] border-b sm:border-b-0 hover:bg-[#111111] transition-colors duration-200">
          <div className="text-[11.5px] text-[#c5a059] tracking-[0.1em] mb-4 font-mono font-medium">
            01
          </div>
          <h3 className="font-serif text-[21px] font-normal text-[#f0ede8] mb-2 leading-[1.25]">
            Clause extraction
          </h3>
          <p className="text-[13.5px] text-[#d4d0c7] leading-[1.65] font-normal">
        ...
        <div className="p-8 sm:p-10 hover:bg-[#111111] transition-colors duration-200">
          <div className="text-[11.5px] text-[#c5a059] tracking-[0.1em] mb-4 font-mono font-medium">
            03
          </div>
          <h3 className="font-serif text-[21px] font-normal text-[#f0ede8] mb-2 leading-[1.25]">
      ...
      {/* 3. Demo Section */}
      <section id="demo" className="bg-[#0e0e0e] border-b border-[#1f1f1d]">
        <div className="px-6 sm:px-10 pt-10 sm:pt-12 flex flex-col sm:flex-row sm:items-baseline justify-between gap-2 border-b border-[#1f1f1d] pb-5">
          <div className="text-[11px] tracking-[0.12em] uppercase text-[#9e998e] font-medium flex items-center gap-2">
            <span className="w-1.5 h-1.5 rounded-full bg-[#4ade80]" />
            Live Demo
          </div>
          <div className="text-[12.5px] text-[#9e998e] font-normal">
        ...
        {/* Error Notification */}
        {error && (
          <div className="mx-6 sm:mx-10 mb-8 p-5 bg-[#240b0b] border border-[#571818] rounded-lg space-y-3">
            ...
            <button
              type="button"
              onClick={handleRetry}
              className="inline-flex items-center gap-2 text-[12px] text-[#fca5a5] hover:text-white transition-colors font-normal border border-[#571818] hover:border-[#822424] rounded px-3 py-1.5 cursor-pointer bg-[#381212]"
            >
              ← Try again
            </button>
          </div>
        ...
        {result && (
          <div className="px-6 sm:px-10 pb-12 pt-6 space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-[#1f1f1d] pb-4 gap-3">
              <div>
                <div className="text-[11.5px] tracking-[0.12em] uppercase text-[#f0ede8] font-medium">
                  Analysis Output — {sortedConflicts.length}{" "}
                  {sortedConflicts.length === 1 ? "conflict" : "conflicts"} detected
                </div>
                <div className="text-[11.5px] text-[#9e998e] font-normal">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="inline-flex items-center gap-1.5 px-3 py-1.5 text-[11.5px] text-[#d4d0c7] hover:text-[#f0ede8] border border-[#292926] hover:border-[#42423d] rounded bg-[#141414] transition-all cursor-pointer font-normal"
                  title="Copy full analysis report as Markdown"
                >
                  <svg className="w-3.5 h-3.5 text-[#9e998e]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {/* Negotiation Summary */}
            <div className="p-5 sm:p-6 bg-[#141414] border border-[#242422] rounded-lg space-y-2">
              <div className="text-[11px] uppercase tracking-[0.1em] text-[#c5a059] font-medium flex items-center gap-1.5">
                <span>Executive Summary</span>
              </div>
              <p className="text-[14px] text-[#e8e4db] leading-[1.7] font-normal">
                {result.summary}
              </p>
            </div>
            ...
            {sortedConflicts.length === 0 ? (
              <div className="p-8 bg-[#141414] border border-[#242422] rounded-lg text-center text-[13.5px] text-[#9e998e] font-normal">
      ...
      <section className="px-6 sm:px-10 py-12 flex flex-wrap items-center justify-between gap-8">
        ...
        <div className="hidden sm:block w-[1px] h-10 bg-[#1f1f1d]" />
